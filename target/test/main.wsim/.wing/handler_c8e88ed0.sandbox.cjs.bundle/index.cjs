...
// target/test/main.wsim/.wing/inflight.$Closure1-5.cjs
var require_inflight_Closure1_5 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-5.cjs"(exports2, module2) {
    "use strict";
...
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure1Client = require_inflight_Closure1_5()({
